...
/**
 * Renders the system-wide admin {@link ReportModel} as a formal management
 * report PDF — executive summary, KPIs with period-over-period deltas,
 * recommendations, supporting breakdowns, and a facility league table.
 */
@Service
public class AdminPdfReportService {
    ...
    public byte[] generate(ReportModel model) {
        ...
        meta.append(model.getScopeName() != null ? model.getScopeName() : "System-Wide");
