...
/**
 * Renders a supervisor {@link ReportModel} as a multi-sheet Excel workbook —
 * the analysis-friendly counterpart to the PDF management report (same content,
 * laid out as sortable/pivotable sheets). See {@link ReportExcelWriter}.
 */
@Service
