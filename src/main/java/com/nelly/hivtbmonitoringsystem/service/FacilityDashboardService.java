...
public class FacilityDashboardService {
    ...
    public FacilityPatientDetailResponse getPatientDetail(UUID patientId) {
        ...
        return FacilityPatientDetailResponse.builder()
                ...
                .registrationRoute(patient.getRegistrationRoute())
                .referralId(patient.getReferralId())
                .suspectedCondition(patient.getSuspectedCondition())
                .screeningNotes(patient.getScreeningNotes())
                .tbSymptomCough(patient.getTbSymptomCough())
                .tbSymptomFever(patient.getTbSymptomFever())
                .tbSymptomNightSweats(patient.getTbSymptomNightSweats())
                .tbSymptomWeightLoss(patient.getTbSymptomWeightLoss())
                .tbSymptomChestPain(patient.getTbSymptomChestPain())
                .presumptiveTb(patient.getPresumptiveTb())
